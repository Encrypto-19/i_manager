...
from users.views import RegisterView, ProfileView, UserProfileUpdateView
...
urlpatterns = [
    ...
    path('profile/<int:pk>/', ProfileView.as_view(template_name='users/profile.html'), name = 'user_profile'),
